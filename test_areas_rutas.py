...
def test_las_exentas_son_solo_entrar_salir_y_las_dos_pantallas():
    ...
    print("OK  test_las_exentas_son_solo_entrar_salir_y_las_dos_pantallas")
...
if __name__ == "__main__":
    ...
    test_las_exentas_son_solo_entrar_salir_y_las_dos_pantallas()
